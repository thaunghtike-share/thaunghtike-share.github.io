...
```  
rolebinding create ပြီးသွားရင်တော့ kubectl config use-context demouser-context နဲ့ demouser-context ကို switch ပြန်လုပ်လိုက်ပါမယ်။ ပြီးရင် demo namespace မှာ nginx deployment ကို create ကြည့်ပါ။ 
