...
lost+found
```
So, restic works well. You got some files inside inside container's mount path. Describe busybox pod.
...
Hope velero can help you and your works a lot. Try velero because it's an open-source project. Thanks for reading ....
