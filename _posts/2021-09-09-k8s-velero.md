...
Firstly, create a backup for busybox pod and pvc. You can also create schedule backups. You can also create backup using cronjob.
...
Use 'velero create backup' to restore kubernetes resources and pvc. Use can restore sources to different namespace with '--namespace-mappings' option. 
