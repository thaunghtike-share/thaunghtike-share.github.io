...
```
မိမိရဲ့ internet connection ပေါ်မူတည်ပြီး ၁၀မိနစ် ကနေ မိနစ်၂၀ အထိကြာနိုင်ပါတယ်။ kubelet error တက်လာရင် cgroup ကို အောက်ပါအတိုင်း disable လုပ်ပေးရပါမယ်။ 
...
```
 နောက်တစ်ကြိမ် kubelet error တက်ရင်လည်း cgroup disable ထပ်လုပ်ပေးပါ။ နောက်ဆုံးမှာ အောက်ကလို token တစ်ခုထွက်လာပါလိမ့်မယ်။
...
ရလာတဲ့ token ကို worker nodes အဖြစ်သုံးမယ့် ကျန် server ၂ခုပေါ်မှာ run လိုက်ပါ။ kubelet error တက်လာရင် kubeadm reset လုပ်ပြီး ခုဏကအတိုင်းပဲ worker တွေမှာလည်း cgroup ကိုပြန် disable လုပ်ပေးပါ။
